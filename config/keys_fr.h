...
#define FR_CCED (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_9_AND_LEFT_PARENTHESIS))



/* Keyboard 7 and & (Ampersand) */
#define FR_NUMBER_7 (LS(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_7_AND_AMPERSAND)))
#define FR_N7 (FR_NUMBER_7)
...
/* Keyboard à (a grave accent) */
#define FR_GRAVE_A (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_0_AND_RIGHT_PARENTHESIS))
#define FR_GR_A (FR_GRAVE_A)

/* Keyboard ù (u grave accent) */
#define FR_GRAVE_U (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_APOSTROPHE_AND_QUOTE ))
#define FR_GR_U (FR_GRAVE_U)
